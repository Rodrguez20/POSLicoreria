    ...
    public class NegocioService : INegocioService
    {
        ...
        public async Task<Negocio> GuardarCambio(Negocio entidad, Stream Logo = null, string NombreLogo = "")
        {
            try
            {
                ...
                negocio_encontrado.NombreLogo = negocio_encontrado.NombreLogo = NombreLogo == ""? NombreLogo : negocio_encontrado.NombreLogo;

                if(Logo != null)
                {
                    string urlLoto = await _firebaseService.SubirStorage(Logo, "carpeta_logo", negocio_encontrado.NombreLogo);
                    negocio_encontrado.UrlLogo = urlLoto;
                }
