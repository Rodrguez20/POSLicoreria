...
namespace SistemaVenta.AplicacionWeb.Controllers
{
    ...
    public class NegocioController : Controller
    {
        ...
        {
            GenericRespose<VMNegocio> gRespose = new GenericRespose<VMNegocio>();
        ...
        public async Task<IActionResult> GuardarCambios([FromForm]IFormFile logo, [FromForm]string modelo)
        {
            ...
            try
            {
                ...
                Negocio negocio_editado = await _negocioService.GuardarCambio(_mapper.Map<Negocio>(vmNegocio), 
